...
import JDate from '@/components/jeecg/JDate.vue' //不要
import JSelectDepart from '@/components/jeecgbiz/JSelectDepart' //不要
import JSelectMultiUser from '@/components/jeecgbiz/JSelectMultiUser' //不要
import JMultiSelectTag from '@/components/dict/JMultiSelectTag' //不要
import JAreaLinkage from '@comp/jeecg/JAreaLinkage' //不要

export default {
  name: 'JSuperQuery',
  mixins: [mixinDevice],
  components: { JAreaLinkage, JMultiSelectTag, JDate, JSelectDepart, JSelectMultiUser }, //不要
  props: {
    /*
       fieldList: [{
          value:'',
