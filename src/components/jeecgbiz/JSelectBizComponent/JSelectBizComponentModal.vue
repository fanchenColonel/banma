    ...
    <a-modal centered :title="name + '选择'" :width="width" :visible="visible" switchFullscreen @ok="handleOk" @cancel="close" cancelText="关闭">
        <a-row :gutter="18">
            <a-col :span="16">
                ...
                <a-table size="middle" bordered :rowKey="rowKey" 
                    :columns="innerColumns" :data-source="userData" 
                    :pagination="ipagination" :scroll="{ y: 240 }" 
                    :rowSelection="{ selectedRowKeys, onChange: onSelectChange, type: 'radio' }" 
                    :customRow="customRowFn" @change="handleTableChange"
                    > 
